...
It develops software for **web development** and more. Some of its most popular products include **Vision**, **Result Portal**, **Multiverse**, **BlackRoad** ,**Microdisk**, and more.

Microintel's products are used by people around the world, from **creative professionals** to **students** to **everyday users**. The company's software has been used to create some of the most iconic documents in history, including the **Dtech CMNR Result-Portal**, **Vision**, **BlackRoad** and more.
